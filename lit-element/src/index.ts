...
export default class MyCustomComponent extends LitElement {
  ...
  subscribeAgentContactDataEvents() {
    agentxJsApi.agentContact.addEventListener("eAgentContact", (
      msg: any /** Service.Aqm.Contact.AgentContact **/
    ) => console.log("AgentContact eAgentContact: ", msg.data));
    agentxJsApi.agentContact.addEventListener(
      "eAgentContactAssigned",
      (msg: any) => console.log("AgentContact eAgentContactAssigned: ", msg)
    );
    agentxJsApi.agentContact.addEventListener(
      "eAgentContactEnded",
      (msg: any) => console.log("AgentContact eAgentContactEnded: ", msg)
    );
    agentxJsApi.agentContact.addEventListener(
      "eAgentContactWrappedUp",
      (msg: any) => console.log("AgentContact eAgentContactWrappedUp: ", msg)
    );
    agentxJsApi.agentContact.addEventListener(
      "eAgentOfferContactRona",
      (msg: { data: { interactionId: string } }) => {
    ...
    agentxJsApi.agentContact.addEventListener(
      "eAgentOfferConsult",
      (msg: any) => console.log("AgentContact eAgentOfferConsult: ", msg)
    );
    ...
    agentxJsApi.agentContact.addEventListener(
      "eAgentContactUnHeld",
      (msg: any) => console.log("AgentContact eAgentContactUnHeld: ", msg)
    );
    agentxJsApi.agentContact.addEventListener(
      "eCallRecordingStarted",
      (msg: any) => console.log("AgentContact eCallRecordingStarted: ", msg)
    );
    agentxJsApi.agentContact.addEventListener(
      "eAgentConsultCreated",
      (msg: any) => console.log("AgentContact eAgentConsultCreated: ", msg)
    );
    agentxJsApi.agentContact.addEventListener(
      "eAgentConsultConferenced",
      (msg: any) => console.log("AgentContact eAgentConsultConferenced: ", msg)
    );
    agentxJsApi.agentContact.addEventListener(
      "eAgentConsultEnded",
      (msg: any) => console.log("AgentContact eAgentConsultEnded: ", msg)
    );
    agentxJsApi.agentContact.addEventListener(
      "eAgentCtqCancelled",
      (msg: any) => console.log("AgentContact eAgentCtqCancelled: ", msg)
    );
    ...
    agentxJsApi.agentContact.addEventListener(
      "eAgentConsultFailed",
      (msg: any) => console.log("AgentContact eAgentConsultFailed: ", msg)
    );
    agentxJsApi.agentContact.addEventListener(
      "eAgentConsultEndFailed",
      (msg: any) => console.log("AgentContact eAgentConsultEndFailed: ", msg)
    );
    ...
    agentxJsApi.agentContact.addEventListener(
      ...
      (msg: any) => console.log("AgentContact eAgentCtqCancelFailed: ", msg)
    );
    agentxJsApi.agentContact.addEventListener(
  ...
  subscribeDialerDataEvents() {
    agentxJsApi.dialer.addEventListener("eOutdialFailed", (msg: any) =>
      console.log("Dialer eOutdialFailed: ", msg)
    );
  }
  ...
  subscribeScreenPopDataEvents() {
    agentxJsApi.screenpop.addEventListener("eScreenPop", (msg: any) =>
      console.log("ScreenPop eScreenPop: ", msg)
    );
  }
  ...
  subscribeNotificationsEvents() {
    agentxJsApi.notifications.addEventListener("add", n => {
      ...
      console.log(
        "Notifications Total: ",
        agentxJsApi.notifications.added.length
      );
    });
    agentxJsApi.notifications.addEventListener("pending", n => {
      console.log("Notifications Pending: ", n);
      console.log(
        "Notifications Total Added: ",
        agentxJsApi.notifications.added.length
      );
      console.log(
        "Notifications Total Pending: ",
        agentxJsApi.notifications.pended.length
      );
      console.log(
        "Notifications Total Activated: ",
        agentxJsApi.notifications.activated.length
      );
      console.log(
        "Notifications Total Deactivated: ",
        agentxJsApi.notifications.deactivated.length
      );
    });
